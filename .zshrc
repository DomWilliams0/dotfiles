...
plugins=(git command-not-found sudo web-search)
...
#bindkey "${terminfo[khnome]}" end-of-line

#cdln() {cd "$(dirname "$(readlink "$1")")";}
...
bindkey "^[0d"    forward-word
bindkey "^[0c"   backward-word
